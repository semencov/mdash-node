...
(function() {
  Mdash.Lib = (function() {
    ...
    Lib.decode_internal_blocks = function(text) {
      var self;
      self = this;
      text = text.replace(new RegExp("" + this.INTERNAL_BLOCK_OPEN + "([a-zA-Z0-9\/=]+?)" + this.INTERNAL_BLOCK_CLOSE, 'g'), function($0, $1) {
  ...
  Mdash.Tret.Abbr = (function(_super) {
    ...
    Abbr.prototype.rules = {
      ...
      nobr_gost: {
        ...
        pattern: [/(\040|\t|\&nbsp\;|^)ГОСТ( |\&nbsp\;)?(\d+)((\-|\&minus\;|\&mdash\;)(\d+))?(( |\&nbsp\;)(\-|\&mdash\;))?/ig, /(\040|\t|\&nbsp\;|^|\>)ГОСТ( |\&nbsp\;)?(\d+)(\-|\&minus\;|\&mdash\;)(\d+)/ig, /(\040|\t|\&nbsp\;|^|\>)LVS( |\&nbsp\;)?(\d+)(\:|\-|\&minus\;|\&mdash\;|)(\d+)/ig, /(\040|\t|\&nbsp\;|^|\>)(RFC|ISO|IEEE)( |\&nbsp\;)?(\d+[.-\/]?\d?)/ig],
        replacement: [
          function(match, m) {
            ...
            return m[1] + this.tag("" + m[2] + " " + m[4], "span", {
              "class": "nowrap"
            });
          }
        ]
